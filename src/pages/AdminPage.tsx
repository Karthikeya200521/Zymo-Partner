...
import { User, Car, X, Save, Edit, Plus, Trash, ShieldAlert, ShieldCheck } from "lucide-react";
...
const AdminPage: React.FC = () => {
  ...
  const [confirmBlockUser, setConfirmBlockUser] = useState<UserData | null>(null);
  const [confirmApproveUser, setConfirmApproveUser] = useState<UserData | null>(null);
  ...
  const blockUser = async (userId: string) => {
    try {
      ...
      const updateCarPromises = carsSnapshot.docs.map((carDoc) =>
        updateDoc(
          doc(appDB, "partnerWebApp", userId, "uploadedCars", carDoc.id),
          {
      ...
      alert(
        `User and their cars have been ${
          newVisibility === 0 ? "blocked" : "unblocked"
        } successfully.`
      );
    } catch (error) {
    ...
    const fetchUsers = async () => {
      try {
        ...
        const userList = querySnapshot.docs.map((doc) => ({
          ...
          unavailableHours: doc.data().unavailableHours || {
            start: "00:00",
            end: "06:00",
          },
        }));
  ...
  const deleteUserAccount = async (userId: string) => {
    try {
      ...
      const deleteCarPromises: Promise<void>[] = carsSnapshot.docs.map(
        (carDoc) =>
          deleteDoc(
            doc(appDB, "partnerWebApp", userId, "uploadedCars", carDoc.id)
          )
  ...
  const handleSaveCar = async () => {
    ...
    try {
      ...
      setUserCars((prev) =>
        prev.map((car) => (car.id === editingCar.id ? { ...editingCar } : car))
      );
  ...
  const CarsModal = () => {
    ...
    const getSafeCarData = (car: CarData) => ({
      ...
      unavailableHours: car.unavailableHours || {
        start: "00:00",
        end: "06:00",
      },
    });
                        ...
                        <div className="flex flex-col md:flex-row gap-6">
                          ...
                          <div className="flex-1 space-y-4">
                            ...
                            <div className="flex justify-between items-start">
                              <div>
                                ...
                                <div className="text-gray-300 text-sm mt-1">
                                  {safeCar.fuelType} •{" "}
                                  {safeCar.transmissionType} •{" "}
                                  {safeCar.noOfSeats} seats •{" "}
                                  {safeCar.yearOfRegistration}
                                </div>
                              </div>
                              <button
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                              <div>
                                ...
                                <div className="text-white">
                                  ₹{safeCar.securityDeposit}
                                </div>
                              </div>
                              <div>
                                <div className="text-gray-400">Min Booking</div>
                                <div className="text-white">
                                  {safeCar.minBookingDuration} {safeCar.unit}
                                </div>
                              </div>
                              <div>
                                <div className="text-gray-400">
                            ...
                            <div className="pt-4 border-t border-lime/20">
                              <h4 className="text-lime font-medium mb-3">
                                Hourly Rental
                              </h4>
                              {safeCar.hourlyRental.limit === "Limited" ? (
                                <div className="space-y-3">
                                  {safeCar.hourlyRental.limited.packages
                                    .length > 0 ? (
                                    safeCar.hourlyRental.limited.packages.map(
                                      (pkg, index) => (
                                        <div
                                          key={index}
                                          className="bg-lightgray/20 p-3 rounded-lg"
                                        >
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                  <div>
                                    ...
                                    <div className="text-white">
                                      ₹
                                      {
                                        safeCar.hourlyRental.unlimited
                                          .fixedHourlyRate
                                      }
                                      /hr
                                    </div>
                            ...
                            {safeCar.weeklyRental.available && (
                              <div className="pt-4 border-t border-lime/20">
                                ...
                                {safeCar.weeklyRental.limit === "Limited" ? (
                                  <div className="space-y-3">
                                    {safeCar.weeklyRental.packages.length >
                                    0 ? (
                                      safeCar.weeklyRental.packages.map(
                                        (pkg, index) => (
                                          <div
                                            key={index}
                                            className="bg-lightgray/20 p-3 rounded-lg"
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mt-2">
                                      <div>
                                        ...
                                        <div className="text-white">
                                          ₹{safeCar.weeklyRental.limitValueKm}
                                          /km
                                        </div>
                                      </div>
                                      <div>
                                        ...
                                        <div className="text-white">
                                          ₹{safeCar.weeklyRental.limitValueHr}
                                          /hr
                                        </div>
                                      </div>
                                    </div>
                                  ...
                                  <div className="grid grid-cols-2 gap-4">
                                    <div>
                                      ...
                                      <div className="text-white">
                                        ₹{safeCar.weeklyRental.rate}/week
                                      </div>
                                    </div>
                                    <div>
                                      <div className="text-gray-400">
                                      ...
                                      <div className="text-white">
                                        ₹{safeCar.weeklyRental.limitValueHr}/hr
                                      </div>
                                    </div>
                                  </div>
                                )}
                            ...
                            {safeCar.monthlyRental.available && (
                              <div className="pt-4 border-t border-lime/20">
                                ...
                                {safeCar.monthlyRental.limit === "Limited" ? (
                                  <div className="space-y-3">
                                    {safeCar.monthlyRental.packages.length >
                                    0 ? (
                                      safeCar.monthlyRental.packages.map(
                                        (pkg, index) => (
                                          <div
                                            key={index}
                                            className="bg-lightgray/20 p-3 rounded-lg"
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mt-2">
                                      <div>
                                        ...
                                        <div className="text-white">
                                          ₹{safeCar.monthlyRental.limitValueKm}
                                          /km
                                        </div>
                                      </div>
                                      <div>
                                        ...
                                        <div className="text-white">
                                          ₹{safeCar.monthlyRental.limitValueHr}
                                          /hr
                                        </div>
                                      </div>
                                    </div>
                                  ...
                                  <div className="grid grid-cols-2 gap-4">
                                    <div>
                                      ...
                                      <div className="text-white">
                                        ₹{safeCar.monthlyRental.rate}/month
                                      </div>
                                    </div>
                                    <div>
                                      <div className="text-gray-400">
                                      ...
                                      <div className="text-white">
                                        ₹{safeCar.monthlyRental.limitValueHr}/hr
                                      </div>
                                    </div>
                                  </div>
                                )}
                              ...
                              <div className="pt-4 border-t border-lime/20">
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                  <div>
                                    ...
                                    <div className="text-white">
                                      ₹{safeCar.deliveryCharges.charges["0-10"]}
                                    </div>
                                  </div>
                                  <div>
                                    <div className="text-gray-400">
                                    ...
                                    <div className="text-white">
                                      ₹
                                      {safeCar.deliveryCharges.charges["10-25"]}
                                    </div>
                                  </div>
                                  <div>
                                    <div className="text-gray-400">
                                    ...
                                    <div className="text-white">
                                      ₹
                                      {safeCar.deliveryCharges.charges["25-50"]}
                                    </div>
                                  </div>
                                </div>
                              </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <Input
                    ...
                    onChange={(e: { target: { value: any } }) =>
                      setEditingUser({ ...editingUser, upiId: e.target.value })
                    }
                  />
                  <Input
                    label="Brand Name"
                ...
                <div className="mt-4">
                  <h3 className="text-lg font-medium text-lime mb-2">
                    Cities Operated
                  </h3>
                  <div className="flex flex-wrap gap-2">
                    {editingUser.cities.map((city, index) => (
                      <div
                        key={index}
                        className="bg-lime/20 text-lime px-3 py-1 rounded-full flex items-center"
                      >
                        {city}
                        <button
                          onClick={() => {
                ...
                <div className="mt-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm text-lime mb-1">
                        Start Time
                      </label>
                      <input
                        type="time"
  ...
  const CarEditModal = () => {
    const [editingPackageIndex, setEditingPackageIndex] = useState<
      number | null
    >(null);
    const [editingPackageType, setEditingPackageType] = useState<
      "hourly" | "weekly" | "monthly" | null
    >(null);
    ...
    const handleAddPackage = (type: "hourly" | "weekly" | "monthly") => {
      ...
      setNewPackage({
        ...
        extraHourRate:
          type === "hourly"
            ? editingCar.hourlyRental.limited.extraHourRate
            : type === "weekly"
            ? editingCar.weeklyRental.limitValueHr
            : editingCar.monthlyRental.limitValueHr,
        extraKmRate:
          type === "hourly"
            ? editingCar.hourlyRental.limited.extraKmRate
            : type === "weekly"
            ? editingCar.weeklyRental.limitValueKm
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <Input
                      ...
                      onChange={(e: { target: { value: string } }) =>
                        setEditingCar({
                          ...editingCar,
                          yearOfRegistration: parseInt(e.target.value) || 0,
                        })
                      }
                    />
                    <Input
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setEditingCar({ ...editingCar, unit: e.target.value })
                        }
                        className="w-full w-full p-2 bg-black/50 border border-lime/30 rounded-lg text-white"
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setEditingCar({
                            ...editingCar,
                            noOfSeats: parseInt(e.target.value) || 4,
                          })
                        }
                        className="  w-full p-2 bg-black/50 border border-lime/30 rounded-lg text-white"
                      >
                  ...
                  <div className="mt-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {(editingCar?.slabRates || []).map((slab, index) => (
                        <div
                          key={index}
                          className="bg-lightgray/10 p-3 rounded-lg"
                        >
                          <div className="font-medium text-lime mb-1">
                            {slab.duration} hours
                          </div>
                          <Input
                            value={slab.rate}
                  ...
                  <div className="pt-4 border-t border-lime/20">
                    <div className="flex justify-between items-center mb-4">
                      <h3 className="text-lg font-medium text-lime">
                        Hourly Rental
                      </h3>
                    ...
                    {editingCar.hourlyRental.limit === "Limited" && (
                      <div className="space-y-4">
                        <div className="flex justify-between items-center">
                          <h4 className="text-md font-medium text-lime">
                            Packages
                          </h4>
                          <button
                        ...
                        {editingCar.hourlyRental.limited.packages.map(
                          (pkg, index) => (
                            <div
                              key={index}
                              className="bg-lightgray/20 p-4 rounded-lg"
                            >
                              ...
                              <div className="flex justify-end gap-2">
                                <button
                                  onClick={() =>
                                    handleRemovePackage("hourly", index)
                                  }
                    ...
                    {editingCar.hourlyRental.limit === "Unlimited" && (
                      <div className="grid grid-cols-2 gap-4">
                        <Input
                          ...
                          value={
                            editingCar.hourlyRental.unlimited.fixedHourlyRate
                          }
                          onChange={(e: { target: { value: any } }) =>
                            setEditingCar({
                              ...editingCar,
                        ...
                        <Input
                          label="Extra Hour Rate"
                          value={
                            editingCar.hourlyRental.unlimited.extraHourRate
                          }
                          onChange={(e: { target: { value: any } }) =>
                            setEditingCar({
                              ...editingCar,
                      ...
                      <>
                        {editingCar.monthlyRental.limit === "Limited" && (
                          <div className="space-y-4">
                            ...
                            {editingCar.monthlyRental.packages.map(
                              (pkg, index) => (
                                <div
                                  key={index}
                                  className="bg-lightgray/20 p-4 rounded-lg"
                                >
                                  <div className="grid grid-cols-2 gap-4 mb-3">
                                    <Input
                                      ...
                                      onChange={(e: {
                                        ...
                                        const packages = [
                                          ...editingCar.monthlyRental.packages,
                                        ];
                                  ...
                                  <div className="flex justify-end gap-2">
                                    <button
                                      onClick={() =>
                                        handleRemovePackage("monthly", index)
                                      }
                                      className="text-red-500 hover:text-red-700 text-sm"
                                    >
                                      Remove
                      ...
                      <>
                        {editingCar.weeklyRental.limit === "Limited" && (
                          <div className="space-y-4">
                            ...
                            {editingCar.weeklyRental.packages.map(
                              (pkg, index) => (
                                <div
                                  key={index}
                                  className="bg-lightgray/20 p-4 rounded-lg"
                                >
                                  <div className="grid grid-cols-2 gap-4 mb-3">
                                    <Input
                                      ...
                                      onChange={(e: {
                                        ...
                                        const packages = [
                                          ...editingCar.weeklyRental.packages,
                                        ];
                                        packages[index].rate = e.target.value;
                                        setEditingCar({
                                          ...editingCar,
                                  ...
                                  <div className="flex justify-end gap-2">
                                    <button
                                      onClick={() =>
                                        handleRemovePackage("weekly", index)
                                      }
                                      className="text-red-500 hover:text-red-700 text-sm"
                                    >
                                      Remove
  ...
  // New wrapper function that handles confirmation
  const deleteUserWithConfirmation = (userId: string) => {
    const user = users.find((u) => u.id === userId);
    if (!user) return;
  ...
  // New wrapper function that handles confirmation
  const blockUserWithConfirmation = (userId: string) => {
    const user = users.find((u) => u.id === userId);
    if (!user) return;
    
    setConfirmBlockUser(user);
  };

  // New wrapper function that handles confirmation
  const approveUserWithConfirmation = (userId: string, isApproved: boolean) => {
    const user = users.find((u) => u.id === userId);
    if (!user) return;
    
    setConfirmApproveUser(user);
  };
    ...
    return (
      <>
        ...
        <ConfirmationDialog 
          ...
          onConfirm={() => {
            if (confirmDeleteUser) {
              deleteUserAccount(confirmDeleteUser.id);
              setConfirmDeleteUser(null);
            }
          }}
          title="Delete Account"
          message={`Are you sure you want to permanently delete ${confirmDeleteUser?.fullName}'s account? This action cannot be undone.`}
          confirmButtonText="Delete"
          confirmButtonColor="bg-red-600 hover:bg-red-700"
          icon={<Trash className="h-10 w-10 text-red-600" />}
        />
        ...
        <ConfirmationDialog 
          ...
          onConfirm={() => {
            if (confirmBlockUser) {
              blockUser(confirmBlockUser.id);
              setConfirmBlockUser(null);
            }
          }}
          title={confirmBlockUser?.visibility === 0 ? "Unblock User" : "Block User"}
          message={
            confirmBlockUser?.visibility === 0 
              ? `Are you sure you want to unblock ${confirmBlockUser?.fullName}? This will make their account and cars visible again.`
              : `Are you sure you want to block ${confirmBlockUser?.fullName}? This will hide their account and cars from being visible.`
          }
          confirmButtonText={confirmBlockUser?.visibility === 0 ? "Unblock" : "Block"}
          confirmButtonColor={confirmBlockUser?.visibility === 0 ? "bg-green-600 hover:bg-green-700" : "bg-orange-600 hover:bg-orange-700"}
        ...
        <ConfirmationDialog 
          ...
          onConfirm={() => {
            if (confirmApproveUser) {
              toggleApproval(confirmApproveUser.id, confirmApproveUser.isApproved);
              setConfirmApproveUser(null);
            }
          }}
          title={confirmApproveUser?.isApproved ? "Remove Approval" : "Approve Vendor"}
          message={
            confirmApproveUser?.isApproved 
              ? `Are you sure you want to remove approval for ${confirmApproveUser?.fullName}?`
              : `Are you sure you want to approve ${confirmApproveUser?.fullName} as a vendor?`
          }
          confirmButtonText={confirmApproveUser?.isApproved ? "Remove Approval" : "Approve"}
          confirmButtonColor={confirmApproveUser?.isApproved ? "bg-orange-600 hover:bg-orange-700" : "bg-lime hover:bg-lime/90"}
  ...
  return (
    <div className="min-h-screen bg-darkgray p-8 font-montserrat">
                ...
                >
                  ...
                  <div className="mt-4 flex flex-col gap-3">
                    <div className="flex justify-between gap-3">
                      ...
                      <button
                        onClick={() => approveUserWithConfirmation(user.id, user.isApproved)}
                    ...
                    <div className="flex justify-between gap-3">
                      <button
                        onClick={() => deleteUserWithConfirmation(user.id)}
                      ...
                      <button
                        onClick={() => blockUserWithConfirmation(user.id)}
      ...
      {/* These dialogs are duplicates and can be removed since we now have renderConfirmationDialogs */}
    </div>
  );
};
